# DxVida — KI Export Copilot

AI-powered export compliance tool for textile and fashion businesses entering the German and European market.

Built as a real working product — no dev team, deployed on Netlify with Claude + serverless functions.

🔗 **Live app:** [dxvida.netlify.app](https://dxvida.netlify.app)
...
*Built by [Pri Hidalgo](https://github.com/phidalgosol-oss) · AI consultant & builder · [LinkedIn](https://linkedin.com/in/prihidalgo)*
